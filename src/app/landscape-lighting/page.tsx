...
import { ArrowLeft, Phone, PhoneOff, Calendar, Sun, Lightbulb, Trees, Fence, Sparkles, Zap } from 'lucide-react';
      ...
      <header className="flex items-center justify-between p-4 border-b border-white/10 bg-bg-secondary/50 backdrop-blur-xl sticky top-0 z-50">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-semibold text-white text-sm sm:text-base">Silent AI Partner for Lighting</h1>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-2xl font-bold text-red-400">$3,800</div>
                  </div>
                ...
                <div className="border-t border-slate-700 pt-6">
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div>
                      <div className="text-2xl font-bold text-emerald-400">$3,503</div>
                      <div className="text-sm text-slate-400">Monthly Savings</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-emerald-400">$42,036</div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm leading-relaxed mb-4">
                The AI office manager built for landscape lighting professionals. Never miss another evening inquiry.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li className="text-slate-400">Lighting Design</li>
                <li className="text-slate-400">LED Installation</li>
                <li className="text-slate-400">Pathway Lights</li>
                <li className="text-slate-400">Accent Lighting</li>
                <li className="text-slate-400">Security Lighting</li>
                <li className="text-slate-400">Holiday Lighting</li>
              </ul>
            </div>
          ...
          <div className="pt-8 border-t border-slate-800/50 mt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-slate-400 text-sm">
                © 2026 Silent AI Partner. Built for lighting professionals.
              </p>
