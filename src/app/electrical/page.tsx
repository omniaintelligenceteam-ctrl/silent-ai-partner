          ...
          <FadeIn>
            <div className="text-center max-w-4xl mx-auto mb-12">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                ...
                <br />
                <span className="gradient-text">Another Electrical Call</span>
              </h1>
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-2xl font-bold text-red-400">$4,400</div>
                  </div>
                ...
                <div className="border-t border-slate-700 pt-6">
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div>
                      <div className="text-2xl font-bold text-emerald-400">$4,103</div>
                      <div className="text-sm text-slate-400">Monthly Savings</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-emerald-400">$49,236</div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm leading-relaxed mb-4">
                The AI office manager built for electricians. Never miss another emergency electrical call.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li className="text-slate-400">Panel Upgrades</li>
                <li className="text-slate-400">Outlet Installation</li>
                <li className="text-slate-400">Rewiring</li>
                <li className="text-slate-400">Ceiling Fan Install</li>
                <li className="text-slate-400">EV Charger Install</li>
                <li className="text-slate-400">Generator Install</li>
                <li className="text-slate-400">Emergency Electrical</li>
              </ul>
            </div>
          ...
          <div className="pt-8 border-t border-slate-800/50 mt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-slate-400 text-sm">
                © 2026 Silent AI Partner. Built for electricians.
              </p>
