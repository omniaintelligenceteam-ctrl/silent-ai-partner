        ...
        <FadeIn delay={200}>
          <div className="flex flex-col sm:flex-row gap-5 justify-center items-center mb-10">
            ...
            <a
              ...
              className="border border-slate-600 text-slate-300 hover:text-white hover:border-slate-400 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-200"
            >
