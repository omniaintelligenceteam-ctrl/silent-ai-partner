...
export function DashboardPreview() {
  const [callsToday, setCallsToday] = useState(87)

  // Live ticking: increment every 8-12s
  useEffect(() => {
    const tick = () => {
        ...
        <FadeIn delay={100}>
          <div className="max-w-5xl mx-auto">
            <TiltCard maxTilt={3}>
              ...
              <div className="glass-card p-8 lg:p-10 gradient-border-animated">
                {/* Header */}
                  ...
                  <div className="lg:col-span-2">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-slate-800/30 rounded-xl p-5">
                        <div className="text-2xl font-bold text-orange-400 tracking-tight mb-1">{callsToday}</div>
                        <div className="text-[10px] text-slate-500 font-mono uppercase tracking-wider">Calls Today</div>
                      </div>
                      <div className="bg-slate-800/30 rounded-xl p-5">
                        <div className="text-2xl font-bold text-emerald-400 tracking-tight mb-1">
                          <AnimatedCounter end={8400} prefix="$" />
                        </div>
